"""
Django settings for LotteIsHorse project.
...
SECRET_KEY = '0!v-@l4^s8ix-z5tsr$wl3kk949at9i%+)umde6tz@a!(f3p)6'
...
ROOT_URLCONF = 'LotteIsHorse.urls'
...
WSGI_APPLICATION = 'LotteIsHorse.wsgi.application'
